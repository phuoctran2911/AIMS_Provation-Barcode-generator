...
- **Adjustable FH position** — the FH ↑/↓ control (in mm) raises the FH asset number from the bottom corner toward the label content, so the empty lower part of each label can be cut off after printing.
